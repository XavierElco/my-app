    ...
    <div className="row">
      <div className="col-lg-3 mb-3">
        ...
        <ul className="list-unstyled small">
          <li className="mb-2">Designed and built with all the love in the world by the <a href="/docs/about/team/">Bootstrap team</a> with the help of <a href="https://github.com/twbs/bootstrap/graphs/contributors">our contributors</a>.</li>
          ...
          <li className="mb-2">当前版本 v5.3.0-alpha1.</li>
        </ul>
      </div>
      <div className="col-6 col-lg-2 offset-lg-1 mb-3">
        ...
        <ul className="list-unstyled">
          ...
          <li className="mb-2"><a href="/docs/">中文文档</a></li>
          <li className="mb-2"><a href="/docs/examples/">示例</a></li>
          <li className="mb-2"><a href="https://icons.bootcss.com/">图标库</a></li>
          <li className="mb-2"><a href="https://www.bootmb.com/">精选模板</a></li>
          <li className="mb-2"><a href="https://blog.getbootstrap.com/">官方博客</a></li>
      ...
      <div className="col-6 col-lg-2 mb-3">
        <h5>指南</h5>
        <ul className="list-unstyled">
          <li className="mb-2"><a href="/docs/getting-started/">入门</a></li>
          <li className="mb-2"><a href="/docs/examples/starter-template/">Starter template</a></li>
          <li className="mb-2"><a href="/docs/getting-started/webpack/">Webpack</a></li>
          <li className="mb-2"><a href="/docs/getting-started/parcel/">Parcel</a></li>
          <li className="mb-2"><a href="/docs/getting-started/vite/">Vite</a></li>
        </ul>
      </div>
      <div className="col-6 col-lg-2 mb-3">
        <h5>项目</h5>
